 ...
 * GCLASS_COLUMNS / AUDIT_LOG_COLUMNSの列定義から自動生成するため、今後アプリ側に
...
/**
 * 在庫リスト・Holdリスト・受注リスト・発注リスト・Gクラス予約リスト・変更履歴を
 * 作成し、Hold期限チェックの時間主導トリガーをセットアップする。GASエディタから
