 ...
 *   受注リスト … 通常Hold／Holdなしからの受注確定時に転記される車両情報＋入力項目＋備考
 *   デモカー受注リスト … デモカーHOLDから受注確定した車両（列は受注リストと同じ）
 *   他店受注リスト … 他店HOLDから受注確定した車両（列は受注リストと同じ）
...
var SHEET_NAMES = {
  ...
  HOLDS: 'Holdリスト',
  ORDERS: '受注リスト',
  DEMO_ORDERS: 'デモカー受注リスト',
  OTHER_STORE_ORDERS: '他店受注リスト',
...
var SALES_LOCATION_OPTIONS = ['岐阜', '大垣', '多治見', '高山'];
...
var VEHICLE_COLUMNS = [
  ...
  },
  {
    ...
    note: '「YYYY-MM」形式で入力してください（例: 2026-09）。日付セル（例: 2026/08/01）' +
      ...
      'ようにしてください。アプリの在庫リストは初期表示で可能月「すべて」を出します。'
  },
